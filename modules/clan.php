...
// echoing the webpage
echo " <h2>Knights of Hell</h2>
</section>
<section>
	<div class='clan_detail'>
		<p>Au dernier relevé, le clan était niveau $clanLevel, nous étions $nbMembers et le clan avait <b>$nbPoints</b> </p>
...
<script> var chart1 = new Highcharts.Chart({
